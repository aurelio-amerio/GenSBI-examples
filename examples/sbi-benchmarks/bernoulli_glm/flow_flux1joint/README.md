...
# Model Card: Flux1joint on bernoulli_glm

This document provides a summary of the `flux1joint` model trained on the `bernoulli_glm` dataset.
...
- **Average C2ST Accuracy:** 0.557 ± 0.019
