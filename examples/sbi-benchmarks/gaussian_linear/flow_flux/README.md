...
# Model Card: Flux on gaussian_linear

This document provides a summary of the `flux` model trained on the `gaussian_linear` dataset.
...
- **Average C2ST Accuracy:** 0.780 ± 0.130
