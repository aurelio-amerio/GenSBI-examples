...
def main():
    ...
    training_config["checkpoint_dir"] = (
        "/home/zaldivar/symlinks/aure/Github/GenSBI-examples/tests/gw_npe_v5/checkpoints"
    )
    ...
    training_config["rtol"] = 1e-2
    # training_config["val_every"] = 1000
    # training_config["max_lr"] = 1e-3#5e-4
    ...
    plt.savefig(f"gw_samples_v5_conf{experiment}.png", dpi=100, bbox_inches="tight")
    plt.show()
    ...
    plot_tarp(ecp, alpha)
    plt.savefig(f"gw_tarp_v5_conf{experiment}.png", dpi=100, bbox_inches="tight") # uncomment to save the figure
    plt.show()
