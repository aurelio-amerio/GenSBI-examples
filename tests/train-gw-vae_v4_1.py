...
def main():
    ...
    training_config["checkpoint_dir"] = (
        "/home/zaldivar/symlinks/aure/Github/GenSBI-examples/tests/gw_npe_v4/checkpoints"
    )
    ...
    plt.savefig(f"gw_samples_v4_conf{experiment}.png", dpi=100, bbox_inches="tight")
    plt.show()
    ...
    plot_tarp(ecp, alpha)
    plt.savefig(f"gw_tarp_v4_conf{experiment}.png", dpi=100, bbox_inches="tight") # uncomment to save the figure
    plt.show()
