...
def main():
    ...
    training_config["checkpoint_dir"] = (
        "/home/zaldivar/symlinks/aure/Github/GenSBI-examples/tests/gw_npe_v6/checkpoints"
    )
    ...
    plt.savefig(f"gw_samples_v6_conf{experiment}.png", dpi=100, bbox_inches="tight")
    plt.show()
    ...
    plot_tarp(ecp, alpha)
    plt.savefig(f"gw_tarp_v6_conf{experiment}.png", dpi=100, bbox_inches="tight") # uncomment to save the figure
    plt.show()
