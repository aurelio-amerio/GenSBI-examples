...
def find_ancestors_jax(mask, node):
    ...
    def body_fn(carry, i):
        ...
        def process_node(is_ancestor, stack, write_idx):
        ...
        def skip_node(is_ancestor, stack, write_idx):
            return is_ancestor, stack, write_idx

        is_ancestor, stack, write_idx = jax.lax.cond(i < write_idx, process_node, skip_node, is_ancestor, stack, write_idx)
        return (is_ancestor, stack, write_idx), None
